...
const config = {
  ...
  plugins: ['import', 'unused-imports', 'react', 'react-hooks', 'prettier', 'module-resolver'],
  settings: {
    'import/resolver': {
      'babel-module': {},
    },
  ...
  rules: {
    ...
    'import/no-unassigned-import': [
      'error',
      {
        allow: ['**/*.css', '**/*.scss', '@testing-library/jest-dom'],
      },
    ],
    'import/order': [
      'error',
    ...
    'import/no-unresolved': [
      ...
      {
        caseSensitive: false,
        ignore: ['.svg', '@gosparsh/components/icons', '.css'],
      },
    ],
